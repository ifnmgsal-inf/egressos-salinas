...
const Footer = () => {
  return (
    <footer className="h-full bg-title border-t-4 border-primary-active">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex xsm:flex-col-reverse md:flex-row items-center md:space-x-40 xl:space-x-52">
          <div className="text-9 text-white py-4 mx-2 xsm:border-t md:border-none">
            Copyright © 2022 Portal Egressos IFNMG-Campus Salinas | Tales Ferreira®
          </div>
