          ...
          <form className="flex flex-col" onSubmit={handleSubmit(handleRegister)}>
            <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col">
                ...
                <input
                  className="h-10 xsm:max-w-350  xsm:min-w-200  xsm:min-w-200 xsm:text-13 md:text-15 border border-grey-text rounded-sm focus:outline-primary-active xsm:px-1 md:px-4 uppercase"
