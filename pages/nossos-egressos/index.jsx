...
export default function EgressosPage() {
  ...
  return (
    <BasePage>
      <div className="flex xsm:flex-col md:flex-col lg:flex-row xl:flex-row justify-between xsm:items-start md:items-start lg:items-center xl:items-center m-10">
        <h1 className="xsm:text-15 sm:text-15 lg:text-20 text-title ">
          Nossos <span className="text-primary-active">egressos</span>
        </h1>
        <label className="flex relative justify-end">
      ...
      <div className="flex flex-col justify-center overflow-x-auto mt-5 mb-20 xsm:mx-5 xl:mx-10 relative">
